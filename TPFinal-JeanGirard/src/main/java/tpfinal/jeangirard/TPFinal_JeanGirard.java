...
//        IConstsFileGenerator constsFile = new ConstsFileGenerator("defaultConsts.cst");
...
//        IConstsFileGenerator constsFile = new ConstsFileGenerator("customConsts.cst");
//        Map<String, String> consts = new HashMap<>();
//        consts.put("e", "2.718281");
//        constsFile.addAll(consts);
